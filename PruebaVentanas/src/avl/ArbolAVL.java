...
public class ArbolAVL {
     ...
     */
    public void insertar(Comparable valor,String contenido, String timestamp, String usuario) {
        raiz = insertar(valor,raiz,contenido,timestamp,usuario);
    }
    /**
     ...
     * @return 
     */
    private NodoAVL insertar(Comparable valor, NodoAVL raiz, String contenido, String timestamp, String usuario){
        ...
        if(raiz == null){
            raiz = new NodoAVL(valor,contenido,timestamp,usuario);
        //Si el nuevo valor fuera menor que el nodo de actual entonces
            ...
            raiz.izquierdo = insertar(valor, raiz.izquierdo,contenido,timestamp,usuario);            
        ...
        //Si el nuevo valor fuera mayor que el nodo de la actual entonces:
        {
            ...
            raiz.derecho=insertar(valor, raiz.derecho, contenido,timestamp,usuario);            
            if(altura(raiz.derecho)-altura(raiz.izquierdo) == 2)
                //Si el factor de equilibrio esta desbalanceado, hay que hacer 
                //rotación de nodos, como el fe=2 hay dos posibilidades de 
                //rotación dependiendo de:                
