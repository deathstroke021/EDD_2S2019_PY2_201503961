...
public class NodoAVL {
     ...
     */
    public NodoAVL(Comparable valor, String contenido, String timestamp, String usuario) {
        this.valor = valor;
     ...
     */
    void insertar(Comparable val, String con, String tim, String usu) {
        ...
        //insertarse a la derecha de este de este.         
            ...
            //Si la derecha del nodo actual esta desocupada entonces se inserta.
                                                if (derecho == null) 
                derecho = new NodoAVL(val,con,tim,usu);
            //De lo contrario nos desplazamos al nodo derecho, en busca de un
            //lugar para insertar el nuevo nodo.            
            else
                derecho.insertar(val,con,tim,usu);
        else
    ...
    private String getCodigoInterno() {
        ...
        if(izquierdo==null && derecho==null){
            etiqueta="nodo"+id+" [ label =\""+"Nombre:" +valor+ " Contenido:" +contenido + " Timestamp:"+timestamp + " Usuario:" +usuario+ " Altura:" + altura + "\"];\n";
        }else{
            etiqueta="nodo"+id+" [ label =\"<C0>|"+"Nombre:" +valor+ " Contenido:" +contenido + " Timestamp:"+timestamp + " Usuario:" +usuario+ " Altura:" + altura + "|<C1>\"];\n";
        }
        if(izquierdo!=null){
